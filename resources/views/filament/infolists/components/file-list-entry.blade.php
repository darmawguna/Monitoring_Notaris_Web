            ...
            <tbody class="divide-y divide-gray-200 whitespace-nowrap dark:divide-white/5">
                ...
                @foreach ($files as $file)
                    <tr class="fi-ta-row">
                        ...
                        <td class="fi-ta-cell p-0 sm:first-of-type:ps-6 sm:last-of-type:pe-6">
                            <div class="px-3 py-4">
                                <span class="text-sm text-gray-950 dark:text-white">
                                    {{-- Mengubah 'ktp_suami' menjadi 'Ktp Suami' --}}
                        ...
                        <td class="fi-ta-cell p-0 sm:first-of-type:ps-6 sm:last-of-type:pe-6">
                            <div class="px-3 py-4">
                                <span class="text-sm text-gray-500 dark:text-gray-400">
                                    {{-- Hanya menampilkan nama file, bukan path lengkap --}}
                                    {{ basename($file->path) }}
                                </span>
                            </div>
                        </td>

                        {{-- Kolom 3: Pratinjau (hanya jika gambar) --}}
                        <td class="fi-ta-cell p-0 sm:first-of-type:ps-6 sm:last-of-type:pe-6">
                            <div class="px-3 py-4">
                        ...
                        {{-- Kolom 4: Tombol Aksi dengan URL yang Benar --}}
                        <td class="fi-ta-cell p-0 sm:first-of-type:ps-6 sm:last-of-type:pe-6">
                            <div class="px-3 py-4 text-center">
                                <a
                                    {{-- Di sini, variabel $file DIJAMIN adalah record yang benar untuk baris ini --}}
                                    href="{{ route('berkas-files.download', ['berkasFile' => $file]) }}"
                                    target="_blank"
